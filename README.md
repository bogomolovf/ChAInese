Open-source часть образовательного проекта Edu ChAInese: telegram бот-дополнение к разрабатываемому приложению для изучению китайского языка с аналогичным названием ChAInese.
